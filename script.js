...
function characterSelection() {
    ...
    $("#ganooId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/spokeyg_game_design_transparent.png";
        chooseOpponentNext()
    });
    ...
    $("#virginelleId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/virginelle_game_design_transparent.png.png";
        chooseOpponentNext()
    });
    ...
    $("#railId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/rail_game_design_transparent.png";
        chooseOpponentNext()
    });
    ...
    $("#clawdiaId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/claudia_game_design_transparent.png";
        chooseOpponentNext()
    });
    ...
    $("#hiJackId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/hijack_game_design_transparent.png";
        chooseOpponentNext()
    });
    ...
    $("#woodiniId").click(function () {
        ...
        console.log(userCharacterSelection);
        $("#user_character").text(userCharacterSelection);
        document.getElementById("userArt").src="./images/woodini_blue_game_design_transparent.png";
        chooseOpponentNext()
    });
...
function opponentCharacterSelection() {
    ...
    $("#oppGanooId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/spokeyg_game_design_transparent.png";
        chooseCourt();
    });
    ...
    $("#oppVirginelleId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/virginelle_game_design_transparent.png.png";
        chooseCourt();
    });
    ...
    $("#oppRailId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/rail_game_design_transparent.png";
        chooseCourt();
    });
    ...
    $("#oppClawdiaId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/claudia_game_design_transparent.png";
        chooseCourt();
    });
    ...
    $("#oppHiJackId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/hijack_game_design_transparent.png";
        chooseCourt();
    });
    ...
    $("#oppWoodiniId").click(function () {
        ...
        console.log(computerCharacterSelection);
        $("#computer_character").text(computerCharacterSelection);
        document.getElementById("computerArt").src="./images/woodini_blue_game_design_transparent.png";
        chooseCourt();
    });
...
function courtSelectionFunc() {
    ...
    $("#rimRockId").click(function () {
        ...
        console.log(courtselection);
        $("#court_select").text( courtselection);
        document.querySelector(".main_game_container").style.background= "URL(./images/rimrock_station_game_design.png)";
        document.querySelector(".main_game_container").style.backgroundSize= "contain";
        document.querySelector(".main_game_container").style.backgroundRepeat= "no-repeat";
        document.querySelector(".main_game_container").style.backgroundPosition= "center";
        gameScript2();
    ...
    $("#lakiaId").click(function () {
        ...
        console.log(courtselection);
        $("#court_select").text( courtselection);
        document.querySelector(".main_game_container").style.background= "URL(./images/rooftop_hoop_game_design.png)";
        document.querySelector(".main_game_container").style.backgroundSize= "contain";
        document.querySelector(".main_game_container").style.backgroundRepeat= "no-repeat";
        document.querySelector(".main_game_container").style.backgroundPosition= "center";
        gameScript2();
    ...
    $("#swishId").click(function () {
        ...
        console.log(courtselection);
        $("#court_select").text( courtselection);
        document.querySelector(".main_game_container").style.background= "URL(./images/divine_park_game_design.png)";
        document.querySelector(".main_game_container").style.backgroundSize= "contain";
        document.querySelector(".main_game_container").style.backgroundRepeat= "no-repeat";
        document.querySelector(".main_game_container").style.backgroundPosition= "center";
        gameScript2();
